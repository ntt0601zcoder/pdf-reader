...
export const MESSAGES = {
  vi: {
    ...
    starOnGithub: 'bạn yêu ơi cho mình xin 1 star trên github nhé 😍',
    ...
    exitAnnotate: 'Xong',
    hintInk: 'Vẽ trực tiếp lên trang',
    hintText: 'Chạm vào trang để thêm ô chữ, rồi gõ',
    hintEraser: 'Chạm hoặc kéo lên nét / chữ để xoá',
  ...
  en: {
    ...
    exitAnnotate: 'Done',
    hintInk: 'Draw directly on the page',
    hintText: 'Tap the page to add a text box, then type',
    hintEraser: 'Tap or drag over ink / text to erase',
